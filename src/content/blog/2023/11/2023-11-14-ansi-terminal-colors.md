...
table { font-family: sans-serif; font-size: 1.2rem; } caption { padding: 1rem; } td { margin: 0 auto; padding: .5rem; text-align: center; } .hexcolor { font-size: 0.8rem; } .ansicode { font-weight: 600; } .lightfont { color: #fff; } .darkfont { color: #000; }
